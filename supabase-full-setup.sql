-- ============================================================
-- ALARIA APP - Setup completo de base de datos
-- Gestión de ventas y arrendamientos de inmuebles - Bogotá
-- Prefijo: house_
-- Ejecutar este script completo en el SQL Editor de Supabase
-- ============================================================

-- ============================================================
-- 1. TABLAS DE CATÁLOGOS (lookup tables)
-- ============================================================
...
-- ============================================================
-- 5. RELACIÓN INMUEBLE <-> AMENIDADES (muchos a muchos)
-- ============================================================
...
-- ============================================================
-- 6. AGENDAS (fechas disponibles por inmueble con asesor)
-- ============================================================
...
INSERT INTO public.house_property_types (name) VALUES
  ('Apartamento'), ('Casa'), ('Estudio'), ('Lote'), ('Oficina'), ('Local Comercial')
ON CONFLICT (name) DO NOTHING;
...
INSERT INTO public.house_property_states (name) VALUES
  ('Disponible'), ('Reservado'), ('Vendido'), ('Arrendado'), ('Pendiente')
ON CONFLICT (name) DO NOTHING;
...
INSERT INTO public.house_amenities (name) VALUES
  ('Balcón'), ('Ascensor'), ('Gimnasio'), ('Piscina'), ('Seguridad 24h'),
  ('Parqueadero visitantes'), ('Zona BBQ'), ('Salón comunal'), ('Terraza'), ('Vigilancia')
ON CONFLICT (name) DO NOTHING;
...
-- 13. STORAGE BUCKET
-- ============================================================
-- IMPORTANTE: Después de ejecutar este script, crear manualmente en
-- Supabase Dashboard > Storage:
--   1. Crear bucket público llamado "property-media"
--   2. Agregar políticas (SELECT, INSERT, UPDATE, DELETE) con:
--        USING (true) / WITH CHECK (true)  para roles anon y authenticated
-- ============================================================

-- ============================================================
-- 14. USUARIO ADMIN INICIAL (opcional - cambiar email/password)
-- ============================================================
-- INSERT INTO public.house_users (email, password, full_name, role_id)
-- VALUES (
--   'admin@alaria.com',
--   '123456',
--   'Administrador Alaria',
